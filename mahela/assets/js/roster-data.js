...
( function () {
	...
	var DEFAULT_TEACHERS = {
		jane:  { id: 'jane',  name: 'Jane Doe',     email: 'jane@mahela.com',  phone: '+98 912 000 0000', status: 'active',     color: 'c-pink',       permissions: { manage_students: true, manage_schedule: true, manage_finance: true, manage_skills: true, send_messages: true } },
		alex:  { id: 'alex',  name: 'Alex Turner',  email: 'alex@mahela.com',  phone: '+98 912 111 2222', status: 'active',     color: 'c-teal',       permissions: { manage_students: true, manage_schedule: true, manage_finance: true, manage_skills: true, send_messages: true } },
		maria: { id: 'maria', name: 'Maria Garcia', email: 'maria@mahela.com', phone: '+98 912 222 3333', status: 'restricted', color: 'c-orange',     permissions: { manage_students: true, manage_schedule: true, manage_finance: false, manage_skills: true, send_messages: false } },
		sam:   { id: 'sam',   name: 'Sam Lee',      email: 'sam@mahela.com',   phone: '+98 912 333 4444', status: 'active',     color: 'c-green',      permissions: { manage_students: true, manage_schedule: true, manage_finance: true, manage_skills: true, send_messages: true } },
		priya: { id: 'priya', name: 'Priya Patel',  email: 'priya@mahela.com', phone: '+98 912 444 5555', status: 'active',     color: 'brand-strong', permissions: { manage_students: true, manage_schedule: true, manage_finance: true, manage_skills: true, send_messages: true } },
		omar:  { id: 'omar',  name: 'Omar Hassan',  email: 'omar@mahela.com',  phone: '+98 912 555 6666', status: 'suspended',  color: 'c-teal',       permissions: { manage_students: false, manage_schedule: false, manage_finance: false, manage_skills: false, send_messages: false } }
	};
